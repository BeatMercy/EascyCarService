...
import static beat.mercy.core.CoreFunc.features;
...
public class Features implements SVMCallback {
     ...
     * (non-Javadoc)
     * 
     * @see com.easycs.core.SVMCallback#getHisteqFeatures(org.bytedeco.javacpp.
     * opencv_core.Mat)
     */
    @Override
     ...
     * 
     * @see
     * com.easycs.core.SVMCallback#getHistogramFeatures(org.bytedeco.javacpp
     * .opencv_core.Mat)
     */
    @Override
     ...
     * 
     * @see
     * com.easycs.core.SVMCallback#getSIFTFeatures(org.bytedeco.javacpp.opencv_core
     * .Mat)
     */
    @Override
     ...
     * 
     * @see
     * com.easycs.core.SVMCallback#getHOGFeatures(org.bytedeco.javacpp.opencv_core
     * .Mat)
     */
    @Override
